...
dht11 DHT;
#define DHT11_PIN 13  //define the DHT11 as the digital pin 7
...
// loop for servomotor, light sensor, temperature+humidity sensor, lcd sensor
void loop() {
...
void LcdShowValue() {
  ...
  // Print temperature, humidity, and light intensity to the Serial Monitor
